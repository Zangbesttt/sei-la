...
local C={V=false,Vel=80,VC=nil,NC=false,NCC=nil,G=nil,GC=nil,A=false,AC=nil,Teclas={Voo="L",Noclip="N",Grudar="K",Atacar="J"},Alvo=nil,GC2=nil}
local sg=Instance.new("ScreenGui")sg.Name="Painel"sg.ResetOnSpawn=false sg.Parent=LP:WaitForChild("PlayerGui")
local st=Instance.new("TextLabel")st.Size=UDim2.new(0,250,0,20)st.Position=UDim2.new(0,20,0,470)st.BackgroundColor3=Color3.fromRGB(5,5,15)st.BorderSizePixel=0 st.Text="✅ Carregado"st.TextColor3=Color3.fromRGB(150,255,150)st.TextSize=10 st.Font=Enum.Font.Gotham st.TextXAlignment=Enum.TextXAlignment.Left st.Parent=sg
...
local function togglePlayers()pF.Visible=not pF.Visible if pF.Visible then up()log("👥 Lista aberta")else log("👥 Lista fechada")end end
...
pB.MouseButton1Click:Connect(togglePlayers)
...
elseif k=="P" then togglePlayers()end end)
